...
ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : <a href='https://t.me/TG_BOTS_UPDATE'>ʜᴀʀɪ ʙᴏᴛᴢ</a>
</b>"""
...
🤡 ᴍʏ ᴍᴀɴᴀɢᴇʀ : <a href="https://telegram.me/harikushal">ʜᴀʀɪ ᴋᴜꜱʜᴀʟ</a></b>"""
...
©️ POWERED BY:- @HK_Filterx_Bot"""
    ...
    ALRT_TXT = """ꜱᴏʀʀʏ ᴅᴇᴀʀ I ᴄᴀɴ'ᴛ ɢɪᴠᴇ ʀᴇǫᴜᴇꜱᴛ ʏᴏᴜʀ ᴏᴡɴ 😊"""
...
<code>/font hi how are you</code></b>"""
    ...
    PREMIUM_TEXT = """<b>👋 Hello Dear,
    
<blockquote><u>Pʀᴇᴍɪᴜᴍ Fᴇᴀᴛᴜʀᴇs</u> 🎁</blockquote>
...
<blockquote><code>harikushal234@okicici</code> ᴜᴘɪ ɪᴅ.</blockquote>
    
○ <u>secoɴᴅ sᴛᴇᴘ</u> : ᴛᴀᴋᴇ ᴀ sᴄʀᴇᴇɴsʜᴏᴛ ᴏғ ʏᴏᴜʀ ᴘᴀʏᴍᴇɴᴛ ᴀɴᴅ sʜᴀʀᴇ ɪᴛ ᴅɪʀᴇᴄᴛʟʏ ʜᴇʀᴇ: @Harikushal

○ <u>ᴀʟᴛᴇʀɴᴀᴛɪᴠᴇ ꜱᴛᴇᴘ</u> : ᴜᴘʟᴏᴀᴅ ᴛʜᴇ sᴄʀᴇᴇɴsʜᴏᴛ ʜᴇʀᴇ ᴀɴᴅ ʀᴇᴘʟʏ ᴡɪᴛʜ ᴛʜᴇ /bought ᴄᴏᴍᴍᴀɴᴅ. <a href='https://t.me/TG_BOTS_UPDATE'>ᴛᴀᴘ ᴛᴏ ꜱᴇᴇ ᴠɪᴅᴇᴏ</a>
...
ᴄʟɪᴄᴋ ᴛʜᴇ ʙᴜᴛᴛᴏɴ ʙᴇʟᴏᴡ ᴛᴏ ᴄᴏɴᴛɪɴᴜᴇ ʙᴜʏɪɴɢ ↡↡↡</b>"""
...
3:- ᴄʀᴇᴀᴛᴇ ᴀᴄᴄᴏᴜɴᴛ ᴏɴ ᴀɴʏ sʜᴏʀᴛɴᴇʀ ʟɪᴋᴇ ʏᴏᴜ ᴄᴀɴ ᴀʟsᴏ ᴜsᴇ ᴛʜɪs ʙᴇsᴛ sʜᴏʀᴛɴᴇʀ <a href=https://modijiurl.com/ref/Harikushal>modijiurl</a>.

4:- ᴛʜᴇɴ sᴇᴛ ʏᴏᴜʀ sʜᴏʀᴛɴᴇʀ ᴅᴇᴛᴀɪʟs ʙʏ ᴛʜɪs ꜰᴏʀᴍᴀᴛ 👇

<code>/set_shortner modijiurl.com 837b7a6ndn4653d1b435f5e20a237840f1251d0c1ce</code>

<code>/set_shortner_2 omnifly.in.net f287e7e9b1hmsa23c34f542f77787d39607cae36a4d</code>

<code>/set_shortner_3 shortslink.in 06b24eb6bbnznxb025713cd522fb3f696b6d5de11354</code>

<code>/set_tutorial https://t.me/TG_Bots_Support/234</code>
...
ಇಂದು ನಿಮ್ಮನ್ನು ಪರಿಶೀಲಿಸಲಾಗಿಲ್ಲ. ದಯವಿಟ್ಟು ಪರಿಶೀಲಿಸು ಕ್ಲಿಕ್ ಮಾಡಿ ಮತ್ತು ಮುಂದಿನ ಪರಿಶೀಲನೆಯವರೆಗೆ ಅನಿಯಮಿತ ಪ್ರವೇಶವನ್ನು ಪಡೆಯಿರಿ ।</b>"""
