...
BIN_CHANNEL = int(environ.get('BIN_CHANNEL','-1002158404983'))
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','-1002491002504'))
URL = environ.get('URL', 'af_mhakal')
STICKERS_IDS = ('CAACAgQAAxkBAAEK99dlfC7LDqnuwtGRkIoacot_dGC4zQACbg8AAuHqsVDaMQeY6CcRojME').split()
FILE_AUTO_DEL_TIMER = int(environ.get('FILE_AUTO_DEL_TIMER', '600'))
IS_VERIFY = is_enabled('IS_VERIFY', True)
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002170171844'))
TUTORIAL = environ.get("TUTORIAL", "https://t.me/TG_Bots_Support/234")
VERIFY_IMG = environ.get("VERIFY_IMG", "https://graph.org/file/1669ab9af68eaa62c3ca4.jpg")
SHORTENER_API = environ.get("SHORTENER_API", "a41c7f7936a7eda1380633085660eab01ef44b58")
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", 'modijiurl.com')
SHORTENER_API2 = environ.get("SHORTENER_API2", "a41c7f7936a7eda1380633085660eab01ef44b58")
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", 'modijiurl.com')
SHORTENER_API3 = environ.get("SHORTENER_API3", "a41c7f7936a7eda1380633085660eab01ef44b58")
...
UPI_PAY_LOGS = int(environ.get('UPI_PAY_LOGS', '-1002238159500'))
